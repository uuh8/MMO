...
namespace GameServer.Managers
{
    class ChatManager : Singleton<ChatManager>
    {
        ...
        public Dictionary<int, List<ChatMessage>> Local = new Dictionary<int, List<ChatMessage>>();  // 本地(int 表示地图id)
        public Dictionary<int, List<ChatMessage>> Team = new Dictionary<int, List<ChatMessage>>();  // 队伍(int 表示队伍id)
        public Dictionary<int, List<ChatMessage>> Guild = new Dictionary<int, List<ChatMessage>>();  // 公会(int 表示公会id)
